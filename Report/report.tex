...
\end{itemize}
To reproduce the attacks the user has to clone the ICSim repository, \texttt{cd ICSim/} and move there the following files:
\begin{itemize}
...
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{../cids fabrication.png}
...
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{../cids suspension.png}
...
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{../cids masquerade.png}
